<template>
    <div>
        ...
        <el-table :data="tableData" height="500" border style="width: 100%">
            ...
            <el-table-column prop="radioId" label="题目ID" width="100">
            </el-table-column>
...
export default {
    ...
    methods: {
        ...
        //更新题目
        update () {
            this.$axios.post(this.apiurl + "teacher/selectRadioByPage", {
        ...
        add: async function () {
            const { value: formValues } = await this.$swal.fire({
                ...
                html:
                    ...
                    '<input id="swal-input7" class="swal2-input" placeholder="答案（请复制上面的选项描述）">',
                focusConfirm: false,
                preConfirm: () => {
                    return [
            ...
            if (formValues) {
                this.$axios.post(this.apiurl + "teacher/addRadio", {
        ...
        page () {
            this.$axios.post(this.apiurl + "/radio/getMaxPage", {})
                .then((result) => {
                    var json = result.data
                    if (json != '')
